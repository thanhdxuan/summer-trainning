...
ALTER TABLE "tests" ADD COLUMN "passed" BOOLEAN NOT NULL ;
ALTER TABLE "tests" ADD COLUMN "topic_id" INTEGER NOT NULL;
ALTER TABLE "posts" ADD COLUMN "read_time" INTEGER DEFAULT 5 ;
ALTER TABLE Tests
ADD CONSTRAINT fk_test_topic_id FOREIGN KEY (topic_id) REFERENCES Topics(topic_id);